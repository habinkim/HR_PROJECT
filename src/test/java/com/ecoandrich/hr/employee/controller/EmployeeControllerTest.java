...
class EmployeeControllerTest extends ControllerBaseTest {
    ...
    void infoListSuccess() throws Exception {
        ...
        mockMvc.perform(get(uri))
                ...
                .andExpect(jsonPath("$.result[0].id", is(206)))
                .andExpect(jsonPath("$.result[0].firstName",is("William")))
                .andExpect(jsonPath("$.result[0].lastName",is("Gietz")))
                .andExpect(jsonPath("$.result[0].email",is("WGIETZ")))
                .andExpect(jsonPath("$.result[0].phoneNumber",is("51hr5.123.8181")))
                .andExpect(jsonPath("$.result[0].hireDate",is("1994-06-07")))
                .andExpect(jsonPath("$.result[0].jobId",is("AC_ACCOUNT")))
                .andExpect(jsonPath("$.result[0].jobTitle",is("Public Accountant")))
                .andExpect(jsonPath("$.result[0].salary",is(8300.00)))
